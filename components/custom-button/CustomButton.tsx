...
function CustomButton(props: BtnProps) {
  ...
  const containedBtn = () => (
    <AppTouchableOpacity
      ...
      style={[
        style.btnContainer,
        style.containedBtnContainer,
        containerStyle,
        disabled && { backgroundColor: color.disableBg },
      ]}
  ...
  const textBtn = () => (
    <AppTouchableOpacity
      onPress={onPress}
      style={[style.txtBtnContainer, containerStyle]}
      disabled={disabled || loading}
    >
      {loading ? (
  ...
  const outlinedBtn = () => (
    <AppTouchableOpacity
      onPress={onPress}
      style={[style.btnContainer, style.outlineBtnContainer, containerStyle]}
      disabled={disabled || loading}
    >
      {loading ? (
        <Loader color={color.primary} />
